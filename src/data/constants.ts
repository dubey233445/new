...
export const SKILLS: Record<SkillNames, Skill> = {
  ...
  [SkillNames.PYTHON]: {
    ...
    name: "python",
    label: "Python",
    shortDescription: "the Swiss Army knife of backend, data, and ML work 🐍",
    color: "#3776ab",
...
export const EXPERIENCE: Experience[] = [
  ...
  },
  {
    ...
    skills: [SkillNames.PYTHON, SkillNames.REACT, SkillNames.TS, SkillNames.GIT],
  },
  {
    id: 5,
    startDate: "2024",
    ...
    skills: [SkillNames.PYTHON, SkillNames.TS, SkillNames.REACT, SkillNames.GIT],
  },
];
